...
class TestFileHandling(DirectoriesMixin, TestCase):
    ...
    def test_document_delete_trash(self):
        ...
        self.assertEqual(os.path.isfile(f"{settings.TRASH_DIR}/none/none.pdf"), False)
        document.delete()
        self.assertEqual(
            os.path.isfile(f"{settings.ORIGINALS_DIR}/none/none.pdf"), False
        )
        ...
        self.assertEqual(os.path.isdir(f"{settings.ORIGINALS_DIR}/none"), False)
        self.assertEqual(os.path.isfile(f"{settings.TRASH_DIR}/none.pdf"), True)
        self.assertEqual(os.path.isfile(f"{settings.TRASH_DIR}/none_01.pdf"), False)
        ...
        Path(document.source_path).touch()
        document.delete()
        self.assertEqual(os.path.isfile(f"{settings.TRASH_DIR}/none_01.pdf"), True)
